...
var createSongRow = function (songNumber, songName, songLength) {
        ...
        var clickHandler = function(testObj) {
...
$(document).ready(function() {
    ...
    $previousButton.click({param: "prev"}, nextPrevSong);
    $nextButton.click({param: "next"}, nextPrevSong);
});